...
const Experience = () => {
  ...
  return (
    <section id="experiences" ref={sectionRef} className="font-sora bg-black text-white px-6 py-20 md:px-16">
      <style>{`
      ...
      <h2 className="text-3xl md:text-4xl text-center mb-16 animate-hidden">
