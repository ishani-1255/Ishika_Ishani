...
const Projects = () => {
  ...
  const projects = [
   ...
   { title: "SecureScan", desc: " A one-click plugin that sniffs out messy vibe code, open vulnerabilities, and sneaky edge cases, cutting development and QA time from months to minutes.", tech: "React, Node.js", gitlink: "https://github.com/ishani-1255/AI-Grand-Challenge", link : "https://marketplace.visualstudio.com/items?itemName=ar1701.vscode-secure-code-analyzer" },
   ...
   { title: "NoteSync", desc: "NoteSync is a Chrome extension that allows users to take notes specific to individual websites.", tech: "HTML, JavaScript", gitlink: "https://github.com/ishani-1255/Note_Sync", link : "https://github.com/ishani-1255/Note_Sync" },
  ];
