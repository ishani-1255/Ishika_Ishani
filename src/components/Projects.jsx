...
const Projects = () => {
  ...
  const projects = [
   ...
   { title: "CusaQuest", desc: "Placement management system. Winner: Make-A-Ton'24", tech: "React, Node.js", gitlink: "https://github.com/ishani-1255/CusaQuest", link : "" },
   { title: "Aquagrove", desc: "ML project for capillary irrigation systems.", tech: "Python", gitlink: "https://github.com/ishani-1255/AquaGrove", link : "" },
   { title: "Crypto Screener", desc: "Real-time crypto tracking dashboard.", tech: "React, Tailwind", gitlink: "https://github.com/ishani-1255/Crypto_Portfolio", link : "crypto-portfolio-ten.vercel.app" },
   { title: "Git Auto", desc: "Python script to automate Git operations.", tech: "Python, Scripting", gitlink: "https://github.com/ishani-1255/git_automate", link : "" },
   { title: "TinyMLHackathon", desc: "Official website for TinyML Hackathon 2024.", tech: "React, Tailwind", gitlink: "https://github.com/MakerGram/tinymlhack2024", link : "" },
  ];
